...
public:
	...
	//Debugging
	Symbol_Table_Entry & get_symbol_entry(){return *symbol_entry;}
...
// check if any more functions are required inside the new Icode_Stmt's
...
public:
        ...
        void print_icode(ostream & file_buffer){file_buffer<<"\tsyscall \n";}
        void print_assembly(ostream & file_buffer){file_buffer<<"\tsyscall \n";}
};
class Function_Call_IC_Stmt: public Icode_Stmt
{
	string function_name;
public:
        Function_Call_IC_Stmt(string name){
        	function_name = name;
        }
